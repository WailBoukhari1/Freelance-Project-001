...
const AboutUsSection = () => {
  ...
  return (
    <section className="about-us-section my-10 py-10 relative bg-cover bg-center bg-no-repeat bg-[url('https://static1.squarespace.com/static/56f18f1c7c65e42974ba15e6/56f3571efb436df53c44b3db/64ed0d2600f99e097974b14a/1703262499218/What+Should+Your+Family+Wear+for+Maternity+Photos+_+Saleem+Maternity+.jpg?format=1500w')]">
      <div className="absolute inset-0 bg-pink-100 opacity-75"></div>
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-6xl font-serif font-light text-center mb-6 text-primary relative before:content-[''] before:absolute before:w-24 before:h-1 before:bg-primary before:-bottom-2 before:left-1/2 before:-translate-x-1/2">
          About Us
        </h2>
        ...
        <h3 className="text-3xl font-semibold mt-12 mb-12 text-center text-gray-800 relative before:content-[''] before:absolute before:w-16 before:h-1 before:bg-gray-800 before:-bottom-2 before:left-1/2 before:-translate-x-1/2">
          Why Choose Us?
        </h3>
